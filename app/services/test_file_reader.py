...
class FileReaderTest(unittest.TestCase):
    ...
    def test_append_and_remove_doc_in_file(self):
        ...
        self.file_reader.append('col', {'id': 123})
        self.assertEqual(self.file_reader.file_len('data-test/col/data1.txt'), 4)

        self.file_reader.update('col', 123, None)
    ...
    def test_update_value(self):
        ...
        self.file_reader.update('col', 2, {'id': 2, 'first_name': 'name2', 'last_name': 'last name2'})
        results = self.file_reader.find('col', search_context)
